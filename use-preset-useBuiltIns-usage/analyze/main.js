(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["__babel_use-preset-usebuiltins-usage__"] = factory();
	else
		root["__babel_use-preset-usebuiltins-usage__"] = factory();
})(self, function() {
...
;// CONCATENATED MODULE: ./use-preset-useBuiltIns-usage/src/promise-module.ts
...
;// CONCATENATED MODULE: ./use-preset-useBuiltIns-usage/src/print-in-browser.ts
...
;// CONCATENATED MODULE: ./use-preset-useBuiltIns-usage/src/index.ts





print_in_browser('THIS IS TEST FOR use-preset-useBuiltIns-usage', 'h1'); // TEST Promise

promise_module(['a', 'b', 'c']).then(function (val) {
  print_in_browser(JSON.stringify(val, null, 2));
}); // TEST Array.fill

print_in_browser(JSON.stringify(Array(5).fill('usage'), null, 2));
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_babel_use_preset_usebuiltins_usage_"] = self["webpackChunk_babel_use_preset_usebuiltins_usage_"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [800], function() { return __webpack_require__(69242); })
