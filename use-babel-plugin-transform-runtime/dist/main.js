(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["__use-babel-plugin-transform-runtime__"] = factory();
	else
		root["__use-babel-plugin-transform-runtime__"] = factory();
})(self, function() {
...
module.exports = __webpack_require__(2726);
...
module.exports = __webpack_require__(6942);
...
module.exports = __webpack_require__(2740);
...
var concat = __webpack_require__(8066);
var concat_default = /*#__PURE__*/__webpack_require__.n(concat);
;// CONCATENATED MODULE: ./use-babel-plugin-transform-runtime/src/promise-module.ts
...
/* harmony default export */ var promise_module = (function (list) {
  return new (promise_default())(function (resolve, reject) {
    ...
    resolve(map_default()(list).call(list, function (val, index) {
      var _context, _context2;

      return concat_default()(_context = concat_default()(_context2 = "[".concat(index + 1, "/")).call(_context2, list.length, "]: ")).call(_context, stringify_default()(val));
    }));
  });
});
;// CONCATENATED MODULE: ./use-babel-plugin-transform-runtime/src/print-in-browser.ts
...
;// CONCATENATED MODULE: ./use-babel-plugin-transform-runtime/src/index.ts
var _context;
...
print_in_browser('THIS IS TEST FOR use-babel-plugin-transform-runtime', 'h1'); // TEST Promise

promise_module(['a', 'b', 'c']).then(function (val) {
  print_in_browser(stringify_default()(val, null, 2));
}); // TEST Array.fill

print_in_browser(stringify_default()(fill_default()(_context = Array(3)).call(_context, 'use-babel-plugin-transform-runtime'), null, 2));
}();
