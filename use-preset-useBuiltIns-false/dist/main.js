(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["__babel_use-preset-usebuiltins-false__"] = factory();
	else
		root["__babel_use-preset-usebuiltins-false__"] = factory();
})(self, function() {
...
/* unused reexport */ __webpack_require__(70717);
...
;// CONCATENATED MODULE: ./use-preset-useBuiltIns-false/src/promise-module.ts
...
;// CONCATENATED MODULE: ./use-preset-useBuiltIns-false/src/print-in-browser.ts
...
;// CONCATENATED MODULE: ./use-preset-useBuiltIns-false/src/index.ts




print_in_browser('THIS IS TEST FOR use-preset-useBuiltIns-false', 'h1'); // TEST Promise

promise_module(['a', 'b', 'c']).then(function (val) {
  print_in_browser(JSON.stringify(val, null, 2));
}); // TEST Array.fill

print_in_browser(JSON.stringify(Array(5).fill('useBuiltIns-false'), null, 2));
}();
